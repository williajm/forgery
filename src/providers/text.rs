...
//!
//! All text generated by this module uses ASCII-only lorem ipsum words.
//! This means `len()` and `truncate()` operations on generated text are
//! byte-safe and equivalent to character operations. If non-ASCII locale
//! data is ever added, this module would need to be updated to use
//! character-boundary-safe operations.
